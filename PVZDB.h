...
public:
    ...
    void GetAllInstancesOfType(int* res, RtTypeId type) {
        ...
        ((getAllInstances)getActualOffset(0x00DE8934))(res, this, type);
    }
    ...
    static T* GetInstance(int* instancesArray) {
        ...
        ((getInstancePtr)getActualOffset(0x00264470))(&instancePtr, instancesArray);
    ...
    static void Increment(int* instancesArray) {
        ...
        ((sub10C5F58)getActualOffset(0x010C5F58))(instancesArray);
    }
};
